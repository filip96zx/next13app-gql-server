...
import    { DateTimeResolver } from 'graphql-scalars';
    export const resolvers: Resolvers = {
      Query: { categories: Query_categories,categoriesConnection: Query_categoriesConnection,category: Query_category,collections: Query_collections,collectionsConnection: Query_collectionsConnection,order: Query_order,product: Query_product,products: Query_products,productsConnection: Query_productsConnection },
      Mutation: { orderCreate: Mutation_orderCreate,orderItemUpdate: Mutation_orderItemUpdate,orderItemsUpdate: Mutation_orderItemsUpdate,productCalculateAndUpdateAverageRating: Mutation_productCalculateAndUpdateAverageRating,productsCalculateAndUpdateAverageRating: Mutation_productsCalculateAndUpdateAverageRating },
